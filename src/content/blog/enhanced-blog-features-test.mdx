...
description: >-
  A comprehensive test post showcasing all the new blog features including KaTeX
  math, interactive components, and media embeds.
pubDate: Jan 25 2025
tags:
  - test
  - features
...
![](../../assets/blog/enhanced-blog-features-test/logo-light.svg)\## Callout Cards
...
One of the most powerful features is full LaTeX math s

![](../../assets/blog/enhanced-blog-features-test/aksaray-universitesi.svg)upport

<Cite id="knuth" num={1} />

. You can write inline math like $E = mc^2$ or the quadratic formula $x^2 = \\frac{x}{y}s$directly in your text.
...
The derivative of a function using t

![](../../assets/blog/enhanced-blog-features-test/afyonkarahisar.webp)he limit definition:
...
&lt;figure&gt; &lt;Image src={img2} alt="A beautiful mountain landscape" width={720} /&gt; &lt;figcaption&gt;A beautiful mountain landscape during sunset&lt;/figcaption&gt; &lt;/figure&gt;
...
You can add citations to your text using the `Cite` component

<Cite id="markdown" num={3} />

. Each citation links to the corresponding reference at the bottom of the page.
